...
// New function to read battery data
void read_battery_data()
{
  float vbat_mv = readVBAT();
  float vbat_percent = mvToPercent(vbat_mv);

  Serial.println("===== Battery Data =====");
  Serial.print("Voltage: ");
  Serial.print(vbat_mv / 1000.0);
  Serial.println(" V");
  ...
  lpp.addVoltage(6, vbat_mv / 1000.0);
  lpp.addAnalogInput(7, vbat_percent);
}
